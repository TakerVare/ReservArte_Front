...
<template>
  ...
  >
    <div class="c_contactInfo__container" :style="{ maxWidth: containerMaxWidth }">
      ...
      <CContactMainTitle :text="openingTitle" :size="atomSize" />
      <COpeningDays :text="openingDays" :size="atomSize" />
      <COpeningHours :text="openingHours1" :size="atomSize" />
      <COpeningHours :text="openingHours2" :size="atomSize" />

      <!-- Sección: Datos de contacto -->
      <CContactMainTitle :text="contactTitle" :size="atomSize" />
